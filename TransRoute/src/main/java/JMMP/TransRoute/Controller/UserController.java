...
public class UserController {
	...
	/**
	 * Metodo para insertar todos los tipos de usuarios teniendo en cuenta de no repetir el email.
	 * Devuelve el usuario que se acaba de insertar o error en caso de no haber insertado nada
	 * @param user
	 * @param altura
	 * @param mma
	 * @param longitud
